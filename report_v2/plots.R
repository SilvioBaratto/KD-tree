...
gg1 <- ggplot(data = strong)+
  ...
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top")
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/strong_OMP.png"), width = 8, height = 6, dpi = 200)
...
gg2 <- ggplot(data = strong)+
  ...
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top")
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/strong_MPI.png"), width = 8, height = 6, dpi = 200)
...
gg2 <- ggplot(data = strong)+
  ...
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top")
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/strong_OMP_MPI.png"), width = 8, height = 6, dpi = 200)
...
gg3 <- ggplot(data = strong)+
  ...
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top")
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/speedupStrong.png"), width = 12, height = 6, dpi = 200)
...
ggw1 <- ggplot(data = weak) +
  ...
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top")
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/weak.png"), width = 12, height = 6, dpi = 200)
...
ggw2 <- ggplot(data = weak)+
  ...
  theme(legend.position = "top") + 
  ylim(0, 5)
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/speedupWeak.png"), width = 12, height = 6, dpi = 200)

efficiency_MPI <- ggplot(data = strong)+
  xlab("N of process (log)") +
  ylab("Efficiency") +
  theme_bw() + 
  scale_x_continuous(trans='log2') +
  scale_color_manual(values = c("#003f5c", "#bc5090")) +
  #scale_x_continuous(trans="log2")+
  geom_line(mapping = aes(nprocs, EfficiencyMPI, col = "Open MPI"), size = 1.5) +
  geom_point(mapping = aes(nprocs, EfficiencyMPI, col = "Open MPI"), size = 3) +
  geom_line(mapping = aes(nprocs, EfficiencyOMP, col = "OpenMP"), size = 1.5) +
  geom_point(mapping = aes(nprocs, EfficiencyOMP, col = "OpenMP"), size = 3) +
  theme(axis.text.x = element_text(size = 14)) +
  theme(axis.text.y = element_text(size = 14)) +
  theme(text = element_text(size = 20)) +
  theme(legend.position = "top") + 
  ylim(0, 5)
ggsave(paste0("~/OneDrive/github/KD-tree/report_v2/EfficiencyWeak.png"), width = 12, height = 6, dpi = 200)
